...
$( document ).ready(function() {
    ...
    $('#user-back-to-top-badge, .back-to-top').click(function() {
        $('#user-scroll-page').animate({
            scrollTop:0
        }, 500, 'easeInOutQuad');
        return false;
    });
    $('#admin-back-to-top-badge, .back-to-top').click(function() {
        $('#admin-scroll-page').animate({
            scrollTop:0
        }, 500, 'easeInOutQuad');
        return false;
    });
    ...
    $('#user-scroll-page').on('scroll', function () {
        var total_scroll_height = $('#user-scroll-page')[0].scrollHeight
        var inside_header = ($(this).scrollTop() <= 60);
        var passed_header = ($(this).scrollTop() >= 0); //250
        var footer_reached = ($(this).scrollTop() >= (total_scroll_height - ($(window).height() +0 )));
        
        if (inside_header == true) {
            $('#user-back-to-top-badge').removeClass('back-to-top-badge-visible');
            $('.user-header-fixed').removeClass('hide-header');
        } else if (passed_header == true)  {
            $('#user-back-to-top-badge').addClass('back-to-top-badge-visible');
            $('.user-header-fixed').addClass('hide-header');
    ...
    $('#admin-scroll-page').on('scroll', function () {
        var total_scroll_height = $('#admin-scroll-page')[0].scrollHeight
        var inside_header = ($(this).scrollTop() <= 60);
        var passed_header = ($(this).scrollTop() >= 0); //250
        var footer_reached = ($(this).scrollTop() >= (total_scroll_height - ($(window).height() +0 )));
        
        if (inside_header == true) {
            $('#admin-back-to-top-badge').removeClass('back-to-top-badge-visible');
            $('.admin-header-fixed').removeClass('hide-header');
        } else if (passed_header == true)  {
            $('#admin-back-to-top-badge').addClass('back-to-top-badge-visible');
            $('.admin-header-fixed').addClass('hide-header');
            //$('.admin-footer-menu-open').removeClass('footer-menu-hidden');
        } 
        if (footer_reached == true){            
            //$('.back-to-top-badge').removeClass('back-to-top-badge-visible');
            $('.admin-admin-header-fixed').addClass('hide-header');
            //$('.admin-footer-menu-open').addClass('footer-menu-hidden');
        }
    });
